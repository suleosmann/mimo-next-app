...
const page = () => {
  ...
  return (
    <div className='mx-8 sm:flex sm:justify-center min-h-screen'>
      <div className=''>
        {statements.map((statement, index) => (
          <div className='mt-6' key={index}>
            ...
            <div className='flex justify-between  text-sm sm:w-[550px] w-full h-[30px]'>
              <div className='flex my-3 font-xs'>
                <div className='bg-gray-400 h-[30px] w-[30px] rounded-full'></div>
                <div className='ml-2'>
                  <h1 className='font-bold'>{statement.entityName}</h1>
                  <h1 className='text-gray-600'>{statement.accountNumber}</h1>
                </div>
              </div>
              <div className='text-right sm:text-[16px] text-xs'>
